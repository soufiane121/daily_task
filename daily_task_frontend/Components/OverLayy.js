...
import { FontAwesome } from '@expo/vector-icons';
 ...
 const Overlayy=(props)=>{
  ...
  return (
        <Overlay isVisible={props.overLay} 
        ...
        >
          ...
          <TextInput multiline = {true}
                    numberOfLines = {4}
                style={styles.txtinpit} placeholderTextColor="black" 
                autoCorrect placeholder="Enter Your Post Here"
                value={props.FeedContent}
                onChange={props.handleContent}
                />
          </View>
          <Button
            icon={ <FontAwesome name="send" size={20} color="white" style={{marginRight: 7}} /> }
            title="Post"
